...
final class DetailInfoViewController: UIViewController {
    ...
    weak var delegate: DetailInfoDelegate?
    ...
    private func setConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            imageView.heightAnchor.constraint(equalToConstant: view.bounds.height * 0.55),
            
            createdAtLabel.topAnchor.constraint(equalTo: locationSignImageView.topAnchor),
            createdAtLabel.widthAnchor.constraint(lessThanOrEqualToConstant: 140),
            ...
            locationSignImageView.topAnchor.constraint(equalTo: imageView.bottomAnchor, constant: 20),
            locationSignImageView.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 20),
    ...
    private func updateUI() {
        ...
        locationSignImageView.isHidden = false
        ...
        for image in FavouriteImages.favourites {
    ...
    private func didTapButton() {
        if isFavourite {
            ...
            let yesAction = UIAlertAction(title: "Yes", style: .default) {_ in
                ...
                for index in 0..<FavouriteImages.favourites.count {
                    if FavouriteImages.favourites[index].id == self.detailedImage!.id {
                        FavouriteImages.favourites.remove(at: index)
            ...
            addToFavouritesButton.setTitle("Remove from favourites", for: .normal)
            addToFavouritesButton.backgroundColor = .red
            FavouriteImages.favourites.append(detailedImage!)
            self.delegate?.didChangeFavouritesList()
        }
    }
